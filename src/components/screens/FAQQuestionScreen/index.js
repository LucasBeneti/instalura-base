    ...
    >
      ...
      >
        <Grid.Col offset={{ sm: 0, lg: 1 }} value={{ xs: 12, md: 4, lg: 4 }}>
          ...
          <Box as="ul" listStyle="none" padding="24px 30px" backgroundColor={theme.colors.borders.main.color} borderRadiusTheme>
            {category.questions.map((currentQuestion) => (
              <Text key={currentQuestion.slug} as="li" variant="paragraph2" href={`/${currentQuestion.slug}`} color="primary.main" marginBottom="16px">
